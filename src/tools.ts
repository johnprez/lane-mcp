...
export function registerLaneTools(server: McpServer, session: LaneSession): void {
  ...
  server.registerTool(
    "lane_render_view",
    {
      ...
      inputSchema: z.object({
        view: z.enum(["availability", "workload", "attention", "activity_log", "project_overview", "project_signals", "milestones", "deliverables", "activities", "portfolio_health"]).describe("Which view to render."),
